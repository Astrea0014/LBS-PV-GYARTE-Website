...
export default function StartSection(){
  return (
    ...
    <section className="h-screen top-0 bg-center bg-cover flex justify-center items-center text-light text-center flex-col" style={{backgroundImage:`url("/lbs-kreativa-gymnasiet-stockholm-sodra-1920x1080.jpg")`}}>
