...
interface CollaberationProjectsProps {
  params : {
    id: string;
  }
}

export default async function CollaberationProjects({params}: CollaberationProjectsProps) {
  ...
  return (
    <main>
      ...
      <section className="flex flex-col justify-center py-16 w-12/12 lg:w-10/12 xl:w-8/12 mx-auto">
        ...
        <div className="flex w-11/12 justify-around mx-auto mb-8 flex-wrap">
